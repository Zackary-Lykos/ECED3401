...
void Song::CreateChannels(vector<int>* data_address,int channels){// Automatically seperates a stream of audio data from a WAV file into individual channels
    double length = data_address->size();
...
Song CreateSong(string f_name){// Takes a wav file and creates a song object from it
    char input;
    char input2;
    int sample;
    vector<int> audio;
